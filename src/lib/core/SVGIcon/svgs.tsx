...
const svgs = {
  wifiFull: (props: any) => (
    <svg
      ...
      {...props}
    >
      <g fill="currentColor" fillRule="nonzero" transform="translate(0 .375)">
  ...
  wifiHigh: (props: any) => (
    <svg
      ...
      {...props}
    >
      <g fill="currentColor" fillRule="nonzero" transform="translate(-.5 -.25)">
        ...
        <path
          d="M19.983 4.15a13.253 13.253 0 0 0-9.4-3.893A13.256 13.256 0 0 0 1.181 4.15S-.042 5.164.79 5.914c.801.722 1.734-.421 1.734-.421a11.36 11.36 0 0 1 8.059-3.337c3.146 0 5.995 1.275 8.057 3.336 0 0 1.062.996 1.656.165.593-.83-.313-1.507-.313-1.507z"
          opacity=".3"
        />
      </g>
    </svg>
  ),
  wifiMedium: (props: any) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="20"
      height="16"
    ...
    >
      <g fill="currentColor" fillRule="nonzero" transform="translate(-.5 .25)">
        ...
        <path d="M10.582 7.853a5.68 5.68 0 0 0-4.028 1.669s-1.155.883-.363 1.675c.792.791 1.706-.331 1.706-.331a3.783 3.783 0 0 1 2.685-1.113c1.05 0 1.998.425 2.686 1.113 0 0 .974 1.023 1.607.33.633-.692-.264-1.674-.264-1.674a5.683 5.683 0 0 0-4.029-1.669z" />
        <path
          d="M17.296 6.836a9.462 9.462 0 0 0-6.713-2.781 9.463 9.463 0 0 0-6.715 2.781s-1.218.977-.427 1.73c.792.75 1.77-.387 1.77-.387a7.575 7.575 0 0 1 5.371-2.225c2.097 0 3.997.85 5.372 2.225 0 0 1.018 1.1 1.71.387.692-.713-.368-1.73-.368-1.73z"
          opacity=".3"
        />
        <path
          d="M19.983 4.15a13.253 13.253 0 0 0-9.4-3.893A13.256 13.256 0 0 0 1.181 4.15S-.042 5.164.79 5.914c.801.722 1.734-.421 1.734-.421a11.36 11.36 0 0 1 8.059-3.337c3.146 0 5.995 1.275 8.057 3.336 0 0 1.062.996 1.656.165.593-.83-.313-1.507-.313-1.507z"
  ...
  wifiLow: (props: any) => (
    ...
    >
      <g fill="currentColor" fillRule="nonzero" transform="translate(-.5 .25)">
        <circle cx="10.5" cy="13.382" r="1.875" />
        <path
          d="M10.582 7.853a5.68 5.68 0 0 0-4.028 1.669s-1.155.883-.363 1.675c.792.791 1.706-.331 1.706-.331a3.783 3.783 0 0 1 2.685-1.113c1.05 0 1.998.425 2.686 1.113 0 0 .974 1.023 1.607.33.633-.692-.264-1.674-.264-1.674a5.683 5.683 0 0 0-4.029-1.669z"
          opacity=".3"
        />
        <path
          d="M17.296 6.836a9.462 9.462 0 0 0-6.713-2.781 9.463 9.463 0 0 0-6.715 2.781s-1.218.977-.427 1.73c.792.75 1.77-.387 1.77-.387a7.575 7.575 0 0 1 5.371-2.225c2.097 0 3.997.85 5.372 2.225 0 0 1.018 1.1 1.71.387.692-.713-.368-1.73-.368-1.73z"
  ...
  wifiNone: (props: any) => (
    <svg
      ...
      {...props}
    >
      <g fill="currentColor" fillRule="nonzero" opacity=".3">
        <circle cx="10" cy="13.132" r="1.875" />
        <path d="M19.483 3.9a13.253 13.253 0 0 0-9.4-3.893A13.256 13.256 0 0 0 .681 3.9S-.542 4.914.29 5.664c.801.722 1.734-.421 1.734-.421a11.36 11.36 0 0 1 8.059-3.337c3.146 0 5.995 1.275 8.057 3.337 0 0 1.062.995 1.656.164.593-.83-.313-1.507-.313-1.507z" />
        <path d="M16.796 6.586a9.462 9.462 0 0 0-6.713-2.781 9.463 9.463 0 0 0-6.715 2.781s-1.218.977-.427 1.73c.792.75 1.77-.387 1.77-.387a7.575 7.575 0 0 1 5.371-2.225c2.097 0 3.997.85 5.372 2.225 0 0 1.018 1.1 1.71.387.692-.713-.368-1.73-.368-1.73z" />
        <path d="M10.082 7.603a5.68 5.68 0 0 0-4.028 1.669s-1.155.883-.363 1.675c.792.791 1.706-.331 1.706-.331a3.783 3.783 0 0 1 2.685-1.113c1.05 0 1.998.425 2.686 1.113 0 0 .974 1.023 1.607.33.633-.692-.264-1.674-.264-1.674a5.683 5.683 0 0 0-4.029-1.669z" />
    ...
    >
      <g fill="none" fillRule="evenodd">
        <path
          stroke="#979797"
          strokeWidth="2"
          d="M5.492 11.757V16.793c0 .51.414.923.924.923h6.75a.91.91 0 0 0 .91-.91V7.043c0-.391.317-.708.708-.708h1.302c.417 0 .755.338.755.754V14.09"
        />
